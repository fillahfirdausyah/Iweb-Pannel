<div class="container">
			<div class="row">
				<div id="sp-logo" class="col-xs-8 col-sm-3 col-md-3">
					<div class="sp-column logobckg" ><a class="logo" href="<?php echo $rs ['site']; ?>"><h1>
					...
					<div class="sp-column flex">			
						<div class='sp-megamenu-wrapper'>
								...
								<ul class="sp-megamenu-parent menu-fade-down-fade-up hidden-xs hidden-sm" >
									<li class="sp-menu-item current-item" ><a href="index.php" style="color:#<?php echo $rs ['font_menu'] ?>">Home</a></li>
									...
									<li class="sp-menu-item <?php echo $rowa ['down'] ?>" ><a style="color:#<?php echo $rs ['font_menu'] ?>" href="p.php?u=<?php echo $rowa['name'] ?>" ><?php echo $rowa ['name'] ?></a>
