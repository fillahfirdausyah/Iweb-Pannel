...
<?php include ("../sec/amenu.php"); ?>
		<h3 >All Slide </h3>
		<br/>
		<button class="button loading-pulse lighten primary" onclick="location='d3a.php';" >Add Slide</button>
		...
		<?php
		$res = $link->query("SELECT * FROM slide");
		...
		?>
			...
			<tr align="center">
				...
				<td>
				<a href="d3e.php?u=<?php echo $rw['codx'] ?>"><span class="fa fa-pencil" aria-hidden="true"></span></a>
				<a onclick="return confirm('Are you want deleting data')" href="d3d.php?u=<?php echo $rw['codx'] ?>"><span class="fa fa-trash" ></span></a>
				</td>
			</tr>
