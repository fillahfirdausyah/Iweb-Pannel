...
<?php include ("../sec/amenu.php"); ?>
		...
		<button class="button loading-pulse lighten primary" onclick="location='d16a.php';" >Add Product</button>
		...
		?>
			...
			<tr align="center">
				...
				<td>
				<a href="d16e.php?u=<?php echo $rw['codx'] ?>"><span class="fa fa-pencil" aria-hidden="true"></span></a>
				<a onclick="return confirm('Are you want deleting data')" href="d16d.php?u=<?php echo $rw['codx'] ?>"><span class="fa fa-trash" ></span></a>
				</td>
			</tr>
