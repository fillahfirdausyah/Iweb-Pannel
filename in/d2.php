...
<?php include ("../sec/amenu.php"); ?>
		...
		<button class="button loading-pulse lighten success" onclick="location='d2z.php';"> AKTIF </button>
		<button class="button loading-pulse lighten danger" onclick="location='d2x.php';"> NON-AKTIF </button>
		<br/>
		<br/>
		<button class="button loading-pulse lighten primary" onclick="location='d2a.php';" >Add Product</button>
		...
		?>
			...
			<tr align="center">
				...
				<td>
				<a href="d2e.php?u=<?php echo $rw['codx'] ?>"><span class="fa fa-pencil" aria-hidden="true"></span></a>
				<a onclick="return confirm('Are you want deleting data')" href="d2d.php?u=<?php echo $rw['codx'] ?>"><span class="fa fa-trash" ></span></a>
				</td>
			</tr>
