...
<?php include ("../sec/amenu.php"); ?>
		<h3 >All Post </h3>
		<br/>
		<button class="button loading-pulse lighten primary" onclick="location='d0a.php';">Add Post</button>
		...
		<?php
		$res = $link->query("SELECT * FROM post");
		...
		?>
			...
			<tr align="center">
				...
				<td>
				<a href="d0e.php?u=<?php echo $rw['codx'] ?>"><span class="fa fa-pencil" aria-hidden="true"></span></a>
				<a onclick="return confirm('Are you want deleting data')" href="d0d.php?u=<?php echo $rw['codx'] ?>"><span class="fa fa-trash" ></span></a>
				</td>
			</tr>
