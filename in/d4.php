...
<?php include ("../sec/amenu.php"); ?>
		<h3 >All Profile </h3>
		<button class="button loading-pulse lighten success" onclick="location='d4z.php';"> AKTIF </button>
		<button class="button loading-pulse lighten danger" onclick="location='d4x.php';"> NON-AKTIF </button>
		<br/>
		<br/>
		...
		<?php
		$res = $link->query("SELECT * FROM business");
		...
		?>
			...
			<tr align="center">
				...
				<td>
				<a href="d4e.php?u=<?php echo $rw['codx'] ?>"><span class="fa fa-pencil" aria-hidden="true"></span></a>
				</td>
			</tr>
