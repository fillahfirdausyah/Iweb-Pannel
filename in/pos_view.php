	...
	function changeValue(id)
	{
		...
		document.getElementById('codxp').value = prdName[id].codxp;
	...
	<form action="../inc/o1.php" method="post">
		<table border="0" cellpadding="5px" cellspacing="1px" style="font-family:Verdana, Geneva, sans-serif; font-size:11px; background-color:#000000" width="100%">
									...
									<tbody> 
											<tr>
												...
												<td style="background-color:#ffffff"><input name="trx" type="text" value="<?php echo $trx ?>" size="7" style="color:#000000" readonly></td>
												<td style="background-color:#ffffff"><input type="text" name="codx" id="codxp" size="7" style="color:#000000" readonly></td>
