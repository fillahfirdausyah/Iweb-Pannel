...
<?php include ("../sec/amenu.php"); ?>
		<h3 >All Pages </h3>
		<br/>
		<button class="button loading-pulse lighten primary" onclick="location='d1a.php';">Add Pages</button>
		...
		<?php
		$res = $link->query("SELECT * FROM page");
		...
		?>
			...
			<tr align="center">
				...
				<td>
				<a href="d1e.php?u=<?php echo $rw['codx'] ?>"><span class="fa fa-pencil" aria-hidden="true"></span></a>
				<a onclick="return confirm('Are you want deleting data')" href="d1d.php?u=<?php echo $rw['codx'] ?>"><span class="fa fa-trash" ></span></a>
				</td>
			</tr>
