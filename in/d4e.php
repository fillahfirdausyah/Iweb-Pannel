...
<div class="login-form padding20 block-shadow">
		<form action="../inc/d4e.php" method="post">
				...
				<input type="hidden" name="id" value="<?php echo $rsi ['id']?>" >
				<div class="input-control text full-size" data-role="input">
				NAME :
				<input type="text" placeholder="isi profile.." name="name" value="<?php echo $rsi['name'] ?>" size="25" >
				</div>
				<br/>
				<br/>
				<div class="input-control text full-size" data-role="input">
				PIC :			
				<input type="text" placeholder="isi pictures link.." name="pic" value="<?php echo $rsi['pic'] ?>" size="25" > 
				</div>
				<br/>
				<br/>
				<div class="input-control text full-size" data-role="input">
				DESCRIPTION :
				<textarea name="des" rows="5" cols="26"><?php echo $rsi['des'] ?></textarea>
				</div>
				<br/>
				<br/>
				<br/>
